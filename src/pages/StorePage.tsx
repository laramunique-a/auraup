  ...
  return (
    <div className="max-w-6xl mx-auto px-3.5 sm:px-6 py-3.5 sm:py-8 flex-1">
      <PageHeader
        ...
        subtitle={<>Adicione baralhos <span className="font-semibold text-slate-700 dark:text-slate-200">prontos e testados</span> à sua conta com <span className="font-semibold text-blue-600 dark:text-blue-400">1 clique</span>. ✨</>}
        actions={
